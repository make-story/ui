...
export default class ModalAlert extends ModalBase {
    ...
    render() {
        ...
        // alert
        let alert = document.querySelector(`[${modalState.attributePrefix}-alert]`);
        if(!alert) {
            alert = document.createElement('div');
            alert.setAttribute(`${modalState.attributePrefix}-alert`, 'alert');
            //alert.style.cssText = 'position: fixed; left: 0px; top: 0px;';
            modalState.container().appendChild(alert);
        }
        ...
        if(this.settings.mask && typeof this.settings.mask === 'object') {
            ...
            this.elements.alert.appendChild(this.elements.mask);
        }
        ...
        this.elements.alert.appendChild(this.elements.container);
