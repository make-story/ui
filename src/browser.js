...
const agent = (global.navigator.userAgent || global.navigator.vendor || global.opera || "").toLowerCase();
const browser = {
...
// browser
(function() {
	const app_name = global.navigator.appName;
	const app_version = global.navigator.appVersion;
